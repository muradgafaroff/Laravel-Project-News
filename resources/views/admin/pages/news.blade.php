            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="primary" style="float: right; color: #f80000">
                        <strong> {{$newsCount}} news found.</strong>  <a class="btn btn-warning" href="{{route('news.trashed')}}"><i class="fa fa-trash" aria-hidden="true"></i> Delete News</a>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($news as $new)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('news.edit',$new->id)}}" class="btn btn-primary"><i
                                            class="fas fa-edit"></i>Up</a>
